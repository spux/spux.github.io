      ...
      if (null != t) {
        ...
        if (
          ...
          if ((null == y && (y = d), void 0 !== t.__d))
            ...
            e: if (null == c || c.parentNode !== e) e.appendChild(d), (i = null)
            else {
...
function E (e, n, t, _, o, r, u, c) {
  ...
  if (((o = 'svg' === n.type || o), null != r))
    for (s = 0; s < r.length; s++)
      if (
        null != (f = r[s]) &&
        ((null === n.type ? 3 === f.nodeType : f.localName === n.type) ||
          e == f)
      ) {
        ;(e = f), (r[s] = null)
        break
